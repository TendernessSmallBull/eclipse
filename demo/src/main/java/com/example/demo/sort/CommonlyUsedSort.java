 ...
 * @date 2019年3月4日
 */
public class CommonlyUsedSort {

	public static void main(String[] args) {
		// int demoArray[] = new int[10];
		// demoArray[0] = 2;
		int intArray[] = {2, 5, 3, 4, 50, 4, 10, 26, 9};
	}
	...
	public static void insertionSort(int[] a) {
		...
		System.out.println(
				"随机数插入排序耗时：" + (System.currentTimeMillis() - startTime) + "毫秒");
	...
	public static void selectionSort(int[] a) {
		...
		System.out.println(
				"随机数选择排序耗时：" + (System.currentTimeMillis() - startTime) + "毫秒");
		for (int i = 0; i < a.length; i++) {
			System.out.print(a[i] + ",");
		}
	}
	...
	public static void bubbleSort(int[] a) {
		...
		System.out.println(
				"随机数冒泡排序耗时：" + (System.currentTimeMillis() - startTime) + "毫秒");
		for (int i = 0; i < a.length; i++) {
			System.out.print(a[i] + ",");
		}
	}
